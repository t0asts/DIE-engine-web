...
extern "C" char* die_dispatch_invoke(die_web::Session* session, int methodId,
    ...
    switch (methodId) {
      ...
      case 6: {
        ...
        bool arg2 = (2 < args.size() && !args[2].isUndefined() && !args[2].isNull()) ? static_cast<bool>(args[2].toBool()) : static_cast<bool>(false);
      ...
      case 7: {
        ...
        if (!obj) return nullptr;
        qint64 arg0 = args[0].toVariant().toLongLong();
        bool arg1 = (1 < args.size() && !args[1].isUndefined() && !args[1].isNull()) ? static_cast<bool>(args[1].toBool()) : static_cast<bool>(false);
      ...
      case 18: {
        ...
        if (!obj) return nullptr;
        qint64 arg0 = args[0].toVariant().toLongLong();
        qint64 arg1 = (1 < args.size() && !args[1].isUndefined() && !args[1].isNull()) ? static_cast<qint64>(args[1].toVariant().toLongLong()) : static_cast<qint64>(50);
      ...
      case 19: {
        ...
        if (!obj) return nullptr;
        qint64 arg0 = args[0].toVariant().toLongLong();
        qint64 arg1 = (1 < args.size() && !args[1].isUndefined() && !args[1].isNull()) ? static_cast<qint64>(args[1].toVariant().toLongLong()) : static_cast<qint64>(256);
        QString arg2 = (2 < args.size() && !args[2].isUndefined() && !args[2].isNull()) ? static_cast<QString>(args[2].toString()) : static_cast<QString>(QString::fromUtf8("System"));
      ...
      case 32: {
        ...
        if (!obj) return nullptr;
        QString arg0 = args[0].toString();
        qint64 arg1 = (1 < args.size() && !args[1].isUndefined() && !args[1].isNull()) ? static_cast<qint64>(args[1].toVariant().toLongLong()) : static_cast<qint64>(0);
      ...
      case 40: {
        ...
        qint64 arg0 = args[0].toVariant().toLongLong();
        qint64 arg1 = args[1].toVariant().toLongLong();
        quint16 arg2 = (2 < args.size() && !args[2].isUndefined() && !args[2].isNull()) ? static_cast<quint16>(static_cast<quint16>(args[2].toInt())) : static_cast<quint16>(0);
      ...
      case 41: {
        ...
        qint64 arg0 = args[0].toVariant().toLongLong();
        qint64 arg1 = args[1].toVariant().toLongLong();
        quint32 arg2 = (2 < args.size() && !args[2].isUndefined() && !args[2].isNull()) ? static_cast<quint32>(args[2].toVariant().toUInt()) : static_cast<quint32>(0);
